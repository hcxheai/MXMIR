      ...
      14, 15, 17, 22, 53:
         begin
            if m_boUseEffect then
               EffectSurface := g_WMonImagesArr[2]{FrmMain.WMon3Img}.GetCachedImage (DEATHEFFECTBASE + m_nCurrentFrame-m_nStartFrame, ax, ay);
         end;
      23:
         begin
            if m_nCurrentAction = SM_DIGUP then begin
               m_BodySurface := nil;
               EffectSurface := g_WMonImagesArr[3]{FrmMain.WMon4Img}.GetCachedImage (m_nBodyOffset + m_nCurrentFrame, ax, ay);
               m_boUseEffect := TRUE;
            end else
               m_boUseEffect := FALSE;
         end;
      ...
      if GetTickCount - m_dwStartTime > m_dwFrameTimetime then begin
         ...
         if (m_nCurrentAction = SM_FLYAXE) and (m_nCurrentFrame-m_nStartFrame = AXEMONATTACKFRAME-4) then begin
            ...
            if meff <> nil then begin
               meff.ImgLib := g_WMonImagesArr[2];//FrmMain.WMon3Img;
               case m_btRace of
...
begin
   if m_nCurrentAction = SM_HIT then begin
      if (frame = 5) and (oldframe <> frame) then begin
         ...
         meff.ImgLib := g_WMonImagesArr[17];//FrmMain.WMon18Img;
...
//(** 6월패치
            ...
            meff := TFlyingArrow (PlayScene.NewFlyObject (self,
                             ...
                             mtFlyArrow));
            if meff <> nil then begin
               meff.ImgLib :=g_WEffectImages;// FrmMain.WEffectImg; //WMon5Img;
...
begin
   inherited LoadSurface;
   if m_boUseEffect then
      EffectSurface :=g_WMonImagesArr[2]{FrmMain.WMon3Img}.GetCachedImage (DEATHFIREEFFECTBASE + m_nCurrentFrame-m_nStartFrame, ax, ay);
end;
...
begin
   ...
   case m_btRace of
      ...
      16://떪협
         begin
            if m_boUseEffect then
               AttackEffectSurface := g_WMonImagesArr[2]{FrmMain.WMon3Img}.GetCachedImage (
      ...
      20://삽落怪쯔
         begin
            if m_boUseEffect then
               AttackEffectSurface := g_WMonImagesArr[3]{FrmMain.WMon4Img}.GetCachedImage (
      ...
      24:
         begin
            if m_boUseEffect then
               AttackEffectSurface := g_WMonImagesArr[0]{FrmMain.WMonImg}.GetCachedImage (
      ...
      40://쉘暇1
         begin
            if m_boUseEffect then begin
               AttackEffectSurface := g_WMonImagesArr[4]{FrmMain.WMon5Img}.GetCachedImage (
                        ZOMBILIGHTINGBASE + (fire16dir * 10) + m_nEffectFrame-m_nEffectStart, //
                        ax, ay);
            end;
            if BoUseDieEffect then begin
               DieEffectSurface := g_WMonImagesArr[4]{FrmMain.WMon5Img}.GetCachedImage (
      ...
      64: begin
        if m_boUseEffect then begin
          AttackEffectSurface := g_WMonImagesArr[19]{FrmMain.WMon20Img}.GetCachedImage (
      ...
      65: begin
        if BoUseDieEffect then begin
          DieEffectSurface:= g_WMonImagesArr[19]{FrmMain.WMon20Img}.GetCachedImage (
...
begin
   ...
   case m_btRace of
      48, 49:
         begin
            if m_boUseEffect then
               AttackEffectSurface := g_WMonImagesArr[6]{FrmMain.WMon7Img}.GetCachedImage (
...
begin
  ...
  if bo260 then begin
    case m_btRace of
      70: begin
        AttackEffectSurface := g_WMonImagesArr[20]{FrmMain.WMon21Img}.GetCachedImage (
      ...
      78: begin
        AttackEffectSurface := g_WMonImagesArr[21]{FrmMain.WMon22Img}.GetCachedImage (
    ...
    if m_boUseEffect then begin
      case m_btRace of
        70: begin
          if m_nCurrentAction = SM_HIT then begin
            n26C := g_WMonImagesArr[20]{FrmMain.WMon21Img}.GetCachedImage (
        ...
        78: begin
          if m_nCurrentAction = SM_HIT then begin
            n26C := g_WMonImagesArr[20]{FrmMain.WMon22Img}.GetCachedImage (
...
begin
  ...
  if (m_btRace = 60) and m_boUseEffect and (m_nCurrentAction = SM_LIGHTING) then begin
    AttackEffectSurface := g_WMonImagesArr[18]{FrmMain.WMon19Img}.GetCachedImage (
                        430 + (firedir * 10) + m_nEffectFrame - m_nEffectStart,
                        ax, ay);
  end;
end;
...
begin
  ...
  if m_nCurrentAction = SM_NOWDEATH then begin
    Eff8:=TNormalDrawEffect.Create(m_nCurrX,m_nCurrY,g_WMonImagesArr[11]{FrmMain.WMon12Img},1420,20,m_dwFrameTime,True);
...
begin
  inherited;
  if m_boUseEffect then
    AttackEffectSurface := g_WMonImagesArr[13]{FrmMain.WMon14Img}.GetCachedImage (
      ...
      if GetTickCount - m_dwStartTime > m_dwFrameTimetime then begin
         ...
         if (m_nCurrentAction = SM_FLYAXE) and (m_nCurrentFrame-m_nStartFrame = 4) then begin
            meff := TFlyingFireBall (PlayScene.NewFlyObject (self,
                             ...
                             mt12));
            if meff <> nil then begin
               meff.ImgLib := g_WMonImagesArr[19]{FrmMain.WMon20Img};
    ...
    if m_boUseEffect then
      case m_btRace of
        75: begin
          case m_nCurrentAction of
            SM_HIT: begin
              n26C := g_WMonImagesArr[21]{FrmMain.WMon22Img}.GetCachedImage (
      ...
      if GetTickCount - m_dwStartTime > m_dwFrameTimetime then begin
         ...
         if (m_nCurrentAction = SM_FLYAXE) and (m_nCurrentFrame - m_nStartFrame = 4) then begin
            meff := TFlyingAxe (PlayScene.NewFlyObject (self,
                             ...
                             mt16));
            if meff <> nil then begin
               meff.ImgLib := g_WMonImagesArr[21]{FrmMain.WMon22Img};
               meff.NextFrameTime := 50;
